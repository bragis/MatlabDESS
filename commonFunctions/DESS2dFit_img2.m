function [adcFitBieri,t2Fit2D,adcFit2D] = DESS2dFit_img2(TRh,TEh,Tgh,TRl,TEl,Tgl,GhArea,GlArea,alphah_deg,alphal_deg,Nstates,e1_H,e2_H,e1_L,e2_L)
...
if (exist(filestr) == 2)
    ...
    % its parameters.
    load(filestr);
    if ((dataBase2D.TRh == TRh) && (dataBase2D.TEh == TEh) && (dataBase2D.Tgh == Tgh) ...
        &&  (dataBase2D.TRl == TRl) && (dataBase2D.TEl == TEl) && (dataBase2D.Tgl == Tgl) ...
        && (dataBase2D.GhArea == GhArea) && (dataBase2D.GlArea == GlArea) ...
        && (dataBase2D.alphah_deg == alphah_deg) && (dataBase2D.alphal_deg == alphal_deg) ...
...
if (matchingDatabaseFound == 0)
    ...
    dataBase2D.alphah_deg = alphah_deg;
    dataBase2D.alphal_deg = alphal_deg;
