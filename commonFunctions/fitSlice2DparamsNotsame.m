function [] = fitSlice2DparamsNotsame(nDessSlice,examPath,seriesNo)
...
TRh = echo1H_info.RepetitionTime/1000;
TEh = echo1H_info.EchoTime/1000;
Tgh = echo1H_info.Tg/1e6;
TRl = echo1L_info.RepetitionTime/1000;
TEl = echo1L_info.EchoTime/1000;
Tgl = echo1L_info.Tg/1e6;
alphah_deg = echo1H_info.FlipAngle;                         % Degrees
alphal_deg = echo1L_info.FlipAngle;                         % Degrees
Nstates = 6;
...
[adcFitBieri_notCorr,t2Fit2D_notCorr,adcFit2D_notCorr] = DESS2dFit_img2(TRh,TEh,Tgh,TRl,TEl,Tgl,GhArea,GlArea,alphah_deg,alphal_deg,Nstates,echo1H,echo2H,echo1L,echo2L);

alpha_deg_L = echo1L_info.FlipAngle;
assumedT1 = 1.2;
t2FitWelschNew_notCorr = -2*(TRl-TEl)./log(echo2L./(echo1L * (sind(alphal_deg/2)).^2 * (1 + exp(-TRl/assumedT1))/(1 - cosd(alphal_deg)*exp(-TRl/assumedT1))));
