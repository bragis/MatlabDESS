...
% respectively.
% It also assumes that if your B1 scan has M slices, then the B1 dicoms are
% arranged as I0001.dcm, ... I000[M].dcm, I000[M+1].dcm, ..., I000[2M].dcm,
% where slices I0001.dcm, ..., I000[M+1].dcm contain the absolute measured 
% flip angle in degrees, multiplied by 10.
...
% 
examPath = '/data/bragi-data/temp/dicoms/ex17258_2016-02-03/';
seriesNo.Hi = '005/';
seriesNo.Lo = '006/';
seriesNo.B1 = '007/';
...
% Note that this assumes that the first half of the B1 dicom series contain the B1 maps.
% This is correct for our implementation of the Bloch-Siegert sequence.
b1SliceLocations = storeB1Locations(examPath,seriesNo.B1);


for (nSlice = sliceRange)
    disp(['Fitting slice no. ', num2str(nSlice), ' (', num2str(nSlice/length(sliceRange)*100), '% ...)']);
    fitSliceB1(nSlice,examPath,seriesNo,b1SliceLocations)
end
